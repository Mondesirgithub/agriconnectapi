"""
Django settings for greenhackaton project.
...
SECRET_KEY = 'django-insecure-45l2m=r3y^2$-zccjrf(a#90gt2$e9xhskxwvqj3+%4jw@h=@5'
...
WSGI_APPLICATION = 'greenhackaton.wsgi.application'
